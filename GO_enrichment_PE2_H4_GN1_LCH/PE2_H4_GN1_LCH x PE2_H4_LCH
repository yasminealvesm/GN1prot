...
filtered_data = data[(data['Comparison (condition 1 / condition 2)'] == 'Test 2 / Ctrl-2') & (data['Pvalue'] < 0.05)]
...
ax.set_title('Top Enriched GO Terms for PE2_H4_GN1_LCH / PE2_H4_LCH')
